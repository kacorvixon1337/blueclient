...
public class ColorComponent extends Component implements PropertyComponent {
    ...
    public ColorComponent(Component parent, ColorProperty colorProperty, int x, int y, int width, int height) {
